...
<div class="col-lg-12">
    ...
    <div class="card card-outline card-success">
        ...
        <div class="card-header">
            ...
            if($_SESSION['login_department_id'] != 8): ?>
...
// Check if query execution failed
    ...
    // Query executed successfully
        ...
        // print_r($row);
                    ...
                    // Remove specific HTML entities that might interfere
                    ...
                    // Replace <li> tags with commas and preserve spaces
            ...
            foreach ($page_ids as $page_id) {
                ...
                if ($result && $result->num_rows > 0) {
                    if ($page_row = $result->fetch_assoc()) {
                        ...
                        $page_info[] = '<a href="edit_image.php?task_id=' . $row['id'] . '" target="_blank">'
                            . ucwords($page_row['pagename']) . '</a>';
                    }
                } else {
                    // Display an error message if the query fails
                    echo "Error fetching page info: " . $conn->error;
                    break; // Exit the loop on query failure
                }
            }

            // Display the page names, separated by commas, or show a default message if empty
            echo !empty($page_info) ? implode(', ', $page_info) : 'No pages available.';
        } else {
   ...
   <?php
    ...
    if ($row['status'] == 0) {
        ...
        echo "<span class='badge badge-info badge-warning' id='onprogress-".$row['id']."' data-task='".$row['id']."'>On-Progress</span>";
...
<td class="text-center">
    ...
    <div class="dropdown-menu" style="">
       ...
       <?php if ($_SESSION['login_type'] == 2 && $_SESSION['login_id'] != 8) : ?>
