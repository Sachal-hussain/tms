		...
		<div class="card-body">
			...
			<input type="hidden" name="created_at" value="<?php echo isset($date_created) ? $date_created : ''; ?>">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=daily_task_hr'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
		...
		$.ajax({
			...
			success:function(resp){
				...
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php?page=daily_task_hr')
					},750)
				}
			}
		})
