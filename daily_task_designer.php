...
<div class="card card-outline card-success">
    <div class="card-header">
        <?php if (($_SESSION['login_id'] == 143 && $_SESSION['login_type'] == 0) || $_SESSION['login_type'] == 2): ?>
        ...
        <table class="table table-hover table-bordered" id="list">
            ...
            <tbody>
                ...
                WHERE 
                 ...
                 $where
                ORDER BY 
                    d.status ASC,  -- Prioritize status (completed first)
                    CASE WHEN d.status = 1 THEN d.date END DESC, -- Completed tasks in descending order of date
                    CASE WHEN d.status = 0 THEN d.date END DESC; -- Pending tasks in descending order of date
                ");
